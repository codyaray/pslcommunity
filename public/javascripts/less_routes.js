...
function companies_path(verb){ return '/companies';}
function companies_ajax(verb, params, options){ return less_ajax('/companies', verb, params, options);}
function companies_ajaxx(verb, params, options){ return less_ajaxx('/companies', verb, params, options);}
function formatted_companies_path(format, verb){ return '/companies.' + format + '';}
function formatted_companies_ajax(format, verb, params, options){ return less_ajax('/companies.' + format + '', verb, params, options);}
function formatted_companies_ajaxx(format, verb, params, options){ return less_ajaxx('/companies.' + format + '', verb, params, options);}
function new_company_path(verb){ return '/companies/new';}
function new_company_ajax(verb, params, options){ return less_ajax('/companies/new', verb, params, options);}
function new_company_ajaxx(verb, params, options){ return less_ajaxx('/companies/new', verb, params, options);}
function formatted_new_company_path(format, verb){ return '/companies/new.' + format + '';}
function formatted_new_company_ajax(format, verb, params, options){ return less_ajax('/companies/new.' + format + '', verb, params, options);}
function formatted_new_company_ajaxx(format, verb, params, options){ return less_ajaxx('/companies/new.' + format + '', verb, params, options);}
function edit_company_path(id, verb){ return '/companies/' + id + '/edit';}
function edit_company_ajax(id, verb, params, options){ return less_ajax('/companies/' + id + '/edit', verb, params, options);}
function edit_company_ajaxx(id, verb, params, options){ return less_ajaxx('/companies/' + id + '/edit', verb, params, options);}
function formatted_edit_company_path(id, format, verb){ return '/companies/' + id + '/edit.' + format + '';}
function formatted_edit_company_ajax(id, format, verb, params, options){ return less_ajax('/companies/' + id + '/edit.' + format + '', verb, params, options);}
function formatted_edit_company_ajaxx(id, format, verb, params, options){ return less_ajaxx('/companies/' + id + '/edit.' + format + '', verb, params, options);}
...
function formatted_company_path(id, format, verb){ return '/companies/' + id + '.' + format + '';}
function formatted_company_ajax(id, format, verb, params, options){ return less_ajax('/companies/' + id + '.' + format + '', verb, params, options);}
function formatted_company_ajaxx(id, format, verb, params, options){ return less_ajaxx('/companies/' + id + '.' + format + '', verb, params, options);}
